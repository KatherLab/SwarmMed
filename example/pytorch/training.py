...
def main(project_id: str):
    ...
    with flare_adapter.get_data_filesystem(project_id) as fs:
        data_dir = fs.get_data_path() # This downloads the data and returns a local path
        ...
        while True:
            ...
            for epoch in range(epochs_per_round):
                ...
                print(f" Round {input_model.current_round} | Epoch {epoch+1} | Loss: {avg_epoch_loss:.4f}")
