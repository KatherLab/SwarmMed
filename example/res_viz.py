...
def main():
    ...
    if not df_list:
        raise RuntimeError("No actual data found in project filesystem. Cannot proceed with visualization.")
    ...
    plt.plot(recall, precision, color='teal', lw=2, label=f'AP = {average_precision_score(y_true, y_probs):.2f}')
