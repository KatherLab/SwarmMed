...
try:
    ...
    if not df_list:
        print(f"No data found in {data_folder}. Please run the generation script first.")
    else:
        # Combine all batches
        ...
        # Replacing Pie chart with a cleaner Bar plot which is standard in scientific papers
        ...
        # Violin plots are often "prettier" and more informative than boxplots for bio-data
        plt.figure(figsize=(10, 6))
        sns.violinplot(data=df, x='diagnosis', y='biomarker_A', palette="Set2", split=True)
