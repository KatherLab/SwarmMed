...
This page provides detailed instructions for setting up the MediSwarm Cloud platform.
...
For secure communication between the participants in the federated learning network, we recommend using a VPN like Tailscale.
