...
def project_membership_required(view_func):
    ...
    def _wrapped_view(request, *args, **kwargs):
        project_id = kwargs.get('pk') or kwargs.get('identifier') or kwargs.get('project_id')
...
def project_context_required(view_func):
    ...
    def _wrapped_view(request, *args, **kwargs):
        try:
            ...
            return render(request, f"apps/{segment}/no_project_selected.html", {"segment": segment})
