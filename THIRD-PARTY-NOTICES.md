...
- **URL:** https://github.com/NVIDIA/NVFlare/blob/main/LICENSE
- **Copyright:** Copyright (c) 2022-2024, NVIDIA CORPORATION.

### Celery
- **License:** BSD-3-Clause
- **URL:** https://github.com/celery/celery/blob/master/LICENSE
- **Copyright:** Copyright (c) 2015-2023, Ask Solem & contributors.
...
### Flowbite
- **License:** MIT
- **URL:** https://github.com/themesberg/flowbite/blob/main/LICENSE.md
- **Copyright:** Copyright (c) 2024 Themesberg

### ApexCharts
- **License:** MIT
- **URL:** https://github.com/apexcharts/apexcharts.js/blob/master/LICENSE
- **Copyright:** Copyright (c) 2018 ApexCharts

---

For a full list of transitive dependencies and their licenses, please refer to `package-lock.json` and the metadata of the installed Python packages.
